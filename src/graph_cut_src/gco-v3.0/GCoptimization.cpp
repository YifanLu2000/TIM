...
OLGA_INLINE void GCoptimization::addterm2_checked(EnergyT* e, VarID i, VarID j, EnergyTermType e00, EnergyTermType e01, EnergyTermType e10, EnergyTermType e11, EnergyTermType w)
{
	...
	// e->add_term2(i,j,e00*w,e01,e10,e11*(1-w));
	// e->add_term2(i,j,0,w,w,e11-w);
	// e->add_term2(i,j,w,w,w,(e01-w));
	// e->add_term2(i,j,0,e01,e01,-w);
	// e->add_term2(i,j,w,e10,e11,0);
	// e->add_term2(i,j,0,w,w,0);
//     e->add_term2(i,j,e00*w,e01*w,e10*w,e11*w);
    // printf("%d,%d: e00:%d, e01:%d, e10:%d, e11:%d, w:%d.\n",i,j,e00,e01,e10,e11,w);
}
